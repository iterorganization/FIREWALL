...
class Solver {
   ...
   private:
    ...
    void build_two_region_grid(const std::vector<double>& x, std::vector<double>& h_face,
    ...
    void assemble_tridiag(const std::vector<double>& T_guess, const std::vector<double>& Tn,
                          const std::vector<double>& rho_cp_nodes, const std::vector<double>& src,
                          double dt, const std::vector<double>& h_face,
                          const std::vector<double>& dx_cell, std::vector<double>& a,
    ...
    void implicit_step(std::vector<double>& Tn, const std::vector<double>& src, double dt,
